                ...
                <div className="movie_detailRight">
                    <div className="movie_detailRightTop">
                        ...
                        <div className="movie_rating">
                            ...
                            <span className="movie_voteCount">{currentMovieDetail ? "(" + currentMovieDetail.vote_count + ") głosów" : ""}</span>
                        </div>  
                        <div className="movie_runtime">{currentMovieDetail ? currentMovieDetail.runtime + " min" : ""}</div>
                        <div className="movie_releaseDate">{currentMovieDetail ? "Data premiery: " + currentMovieDetail.release_date : ""}</div>
